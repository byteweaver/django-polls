...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Vote', fields ['poll', 'user']
        db.create_unique('polls_vote', ['poll_id', 'user_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Vote', fields ['poll', 'user']
        db.delete_unique('polls_vote', ['poll_id', 'user_id'])
